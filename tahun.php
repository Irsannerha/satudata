                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    ...
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editModal<?php echo $id_tahun; ?>"><i class="dw dw-edit2"></i> Edit</a>
                                    <a id="sa-warning" class="dropdown-item sa-warning" href="#" data-id="<?php echo $tahun; ?>"><i class="dw dw-delete-3"></i> Delete</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="saveData()">Save</button>
                    ...
                    <!-- Modal Edit -->
                    <div class="modal fade" id="editModal<?php echo $id_tahun; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_opd<?php echo $id_tahun; ?>" value="<?php echo $id_tahun; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="tahun<?php echo $tahun; ?>">Tahun</label>
                                            <input type="text" class="form-control" id="tahun<?php echo $tahun; ?>" value="<?php echo $tahun; ?>">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
