...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>Data Users | Satu Data Bandar Lampung</title>
...
$sql = mysqli_query($conn, "SELECT id, username, email, password FROM users ");
$result = $sql->num_rows;
?>


<div class="card-box mb-30"> 
    <h2 class="h4 pd-20">DATA USERS</h2>
...
?>
        <tr>
            ...
            <td>
                <h5 class="font-16"><?php echo $id; ?></h5>
            </td>
            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editModal<?php echo $id; ?>"><i class="dw dw-edit2"></i> Edit</a>
                        <a class="dropdown-item sa-warning" href="#" data-id="<?php echo $id; ?>"><i class="dw dw-delete-3"></i> Delete</a>
                    </div>
                </div>
            </td>
        </tr> 
      ...
      <div class="modal-body">
        <div class="invoice-wrap">
          <div class="invoice-box">
            ...
            <h4 class="text-center mb-30 weight-300"> DATA Tahun <?php echo $tahun; ?> </h4>
            <div class="row pb-30">
              <div class="col-md-6">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Add Data Pengguna</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="username<?php echo $id; ?>" value="<?php echo $username; ?>">
          </div>
          <div class="form-group">
            <label for="email<?php echo $id; ?>">Email</label>
            <input type="email" class="form-control" id="email<?php echo $id; ?>" value="<?php echo $email; ?>">
          </div>
          <div class="form-group">
            <label for="password<?php echo $id; ?>">Password</label>
            <input type="password" class="form-control" id="password<?php echo $id; ?>" value="<?php echo $password; ?>">
          </div>
        </form>
      </div>
      <div class="modal-footer">
